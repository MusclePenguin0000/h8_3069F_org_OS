...
#define H8_3069F_SCI_SCR_RE         (1<<4)  /* 受診有効       */
#define H8_3069F_SCI_SCR_TE         (1<<5)  /* 送信有効       */
#define H8_3069F_SCI_SCR_RIE        (1<<6)  /* 受診割込み有効 */
...
/* ※一度しか使わないケースでは、構造体に名前は不要らしい */
/* https://qiita.com/kenichiuda/items/671034c3bcdbc385f657 */
static struct {
